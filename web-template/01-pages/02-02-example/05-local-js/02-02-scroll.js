...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          02-02-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-020000').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--020000').offset().top }, 250);
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-020200').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--020200').offset().top -20}, 250);
    });                                         /* END of scroll function */

    $('.js--sc-020201').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--020201').offset().top -20}, 1000);
    });                                         /* END of scroll function */
    $('.js--sc-020202').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--020202').offset().top -20}, 1000);
    });                                         /* END of scroll function */
    $('.js--sc-020203').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--020203').offset().top -20}, 1000);
    });                                         /* END of scroll function */
    $('.js--sc-020204').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--020204').offset().top -20}, 1000);
    });                                         /* END of scroll function */
    $('.js--sc-020205').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--020205').offset().top -20}, 1000);
    });                                         /* END of scroll function */
    $('.js--sc-020206').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--020206').offset().top -20}, 1000);
    });                                         /* END of scroll function */
    $('.js--sc-020207').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--020207').offset().top -20}, 1000);
    });                                         /* END of scroll function */
    $('.js--sc-020208').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--020208').offset().top -20}, 1000);
    });                                         /* END of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-f02-02').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--f02-02').offset().top -80}, 1000);
    });                                         /* END of scroll function */
    $('.js--sc-f02-03').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--f02-03').offset().top -80}, 1000);
    });                                         /* END of scroll function */
    $('.js--sc-t02-02').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--t02-02').offset().top -80}, 1000);
    });                                         /* END of scroll function */
