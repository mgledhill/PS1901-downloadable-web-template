...
*******************************************************************************
Title :          LOCAL SCROLL - JQUERY                          80-00-SCROLL.JS
*******************************************************************************
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-800000').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--800000').offset().top -10}, 1000);
    });                                         /* END of scroll function */
...
/* ---------------------------------------------------------------------------
   ...
   ------------------------------------------------------------------------- */
    $('.js--sc-800100').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--800100').offset().top }, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-800200').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--800200').offset().top -20}, 1000);
    });                                         /* END of scroll function */

    $('.js--sc-800300').click(function () {     /* START of scroll function */
       $('html, body').animate({scrollTop: $('#js--800300').offset().top -20}, 1000);
    });                                         /* END of scroll function */
